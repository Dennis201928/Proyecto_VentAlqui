    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Alquiler de Maquinaria</span>
            </nav>
        </div>
    </div>
</div>
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="border-bottom mb-4 pb-4">
                ...
                <form method="GET" action="<?php echo $baseUrl ?? '/Proyecto_VentAlqui/public'; ?>/alquiler">
                            ...
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <?php if ($current_user): ?>
                                            <a class="btn btn-outline-dark btn-square" href="<?php echo $baseUrl ?? '/Proyecto_VentAlqui/public'; ?>/alquiler/<?php echo $product['id']; ?>" title="Agendar Alquiler">
                                                <i class="fa fa-calendar"></i>
                                            </a>
                                        <?php else: ?>
                                            <a class="btn btn-outline-dark btn-square" href="<?php echo $baseUrl ?? '/Proyecto_VentAlqui/public'; ?>/login" title="Inicia sesión para alquilar">
                                                <i class="fa fa-calendar"></i>
                                            </a>
                                        <?php endif; ?>
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <?php if (!empty($product['precio_alquiler_dia']) && $product['precio_alquiler_dia'] > 0): ?>
                                            <h6>$<?php echo number_format($product['precio_alquiler_dia'], 2); ?>/día</h6>
                                        <?php else: ?>
